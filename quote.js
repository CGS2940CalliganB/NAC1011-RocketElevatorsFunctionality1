...
// Function to calculate Residential Elevators required
...
function calculateResidentialElevators(numberOfFloors, numberOfApartment) {
    ...
    let ELEVATORS_BANK = Math.ceil(ELEVATORS_NEEDED / 20);

    // Return the total amount of elevators 
    return ELEVATORS_NEEDED * ELEVATORS_BANK;
}

// Function to calculate Commercial Elevators required
...
function calculateCommercialElevators(numberOfFloors, maximumOccupancyPerFloor) {
    ...
    // Set the varialbe of the amount of elevators bank
    let ELEVATOR_BANKS_REQUIRED = Math.ceil(ELEVATORS_REQUIRED_PER_BANK / 10);

    // Set the varialbe of the total amount of elevators required per bank
    let TOTAL_ELEVATORS_REQUIRED_PER_BANK = ELEVATOR_BANKS_REQUIRED * 20;

    // Set the varialbe of the amount of additional elevators for freight
    let ADDITIONAL_ELEVATOR_FOR_FREIGHT_PER_BANK = Math.ceil(TOTAL_ELEVATORS_REQUIRED_PER_BANK / 200);
...
// <!-- Importing Quote Form JavaScript -->
